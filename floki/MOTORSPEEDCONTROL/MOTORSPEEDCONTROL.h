...
#define MOTORSPEEDCONTROL_K_INIT				 45.0
#define MOTORSPEEDCONTROL_K_NOM				     177.1
#define MOTORSPEEDCONTROL_K_DELTA				 0.05
#define MOTORSPEEDCONTROL_W_ZERO		 		 6.59
#define MOTORSPEEDCONTROL_W_POLE		 		 18.73
#define MOTORSPEEDCONTROL_W_DELTA				 60.0
